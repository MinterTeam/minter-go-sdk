...
func (m *ValidatorsResponse) validateValidators(formats strfmt.Registry) error {
...
func (m *ValidatorsResponse) contextValidateValidators(ctx context.Context, formats strfmt.Registry) error {
