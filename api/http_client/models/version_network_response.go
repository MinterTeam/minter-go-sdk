...
func (m *VersionNetworkResponse) validateVersions(formats strfmt.Registry) error {
...
func (m *VersionNetworkResponse) contextValidateVersions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VersionNetworkResponse) UnmarshalBinary(b []byte) error {
	var res VersionNetworkResponse
