...
func (o *EstimateCoinBuyParams) WithCoinIDToBuy(coinIDToBuy *int64) *EstimateCoinBuyParams {
	o.SetCoinIDToBuy(coinIDToBuy)
	return o
}

// SetCoinIDToBuy adds the coinIdToBuy to the estimate coin buy params
func (o *EstimateCoinBuyParams) SetCoinIDToBuy(coinIDToBuy *int64) {
	o.CoinIDToBuy = coinIDToBuy
}

// WithCoinIDToSell adds the coinIDToSell to the estimate coin buy params
func (o *EstimateCoinBuyParams) WithCoinIDToSell(coinIDToSell *int64) *EstimateCoinBuyParams {
	o.SetCoinIDToSell(coinIDToSell)
	return o
}

// SetCoinIDToSell adds the coinIdToSell to the estimate coin buy params
func (o *EstimateCoinBuyParams) SetCoinIDToSell(coinIDToSell *int64) {
