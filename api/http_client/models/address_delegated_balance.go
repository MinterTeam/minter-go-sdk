...
func (m *AddressDelegatedBalance) validateCoin(formats strfmt.Registry) error {
...
func (m *AddressDelegatedBalance) contextValidateCoin(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AddressDelegatedBalance) UnmarshalBinary(b []byte) error {
	var res AddressDelegatedBalance
