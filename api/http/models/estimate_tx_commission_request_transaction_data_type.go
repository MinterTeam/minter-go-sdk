...
func init() {
	...
	if err := json.Unmarshal([]byte(`["unknown","Send","SellCoin","SellAllCoin","BuyCoin","CreateCoin","DeclareCandidacy","Delegate","Unbond","RedeemCheck","SetCandidateOnline","SetCandidateOffline","CreateMultisig","Multisend","EditCandidate","RecreateCoin","EditOwner"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
