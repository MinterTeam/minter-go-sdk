...
func (o *EstimateCoinSellAllParams) WithCoinIDToBuy(coinIDToBuy *int64) *EstimateCoinSellAllParams {
	o.SetCoinIDToBuy(coinIDToBuy)
	return o
}

// SetCoinIDToBuy adds the coinIdToBuy to the estimate coin sell all params
func (o *EstimateCoinSellAllParams) SetCoinIDToBuy(coinIDToBuy *int64) {
	o.CoinIDToBuy = coinIDToBuy
}

// WithCoinIDToSell adds the coinIDToSell to the estimate coin sell all params
func (o *EstimateCoinSellAllParams) WithCoinIDToSell(coinIDToSell *int64) *EstimateCoinSellAllParams {
	o.SetCoinIDToSell(coinIDToSell)
	return o
}

// SetCoinIDToSell adds the coinIdToSell to the estimate coin sell all params
func (o *EstimateCoinSellAllParams) SetCoinIDToSell(coinIDToSell *int64) {
