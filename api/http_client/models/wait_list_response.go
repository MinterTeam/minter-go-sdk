...
func (m *WaitListResponse) validateList(formats strfmt.Registry) error {
...
func (m *WaitListResponse) contextValidateList(ctx context.Context, formats strfmt.Registry) error {
